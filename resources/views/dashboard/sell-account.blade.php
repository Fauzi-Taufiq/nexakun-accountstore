...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl p-6 text-white shadow-xl animate-fade-in">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-3xl font-bold mb-2">Jual Akun Game</h2>
                <p class="text-purple-100">Isi informasi detail akun game yang ingin Anda jual</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-dark-800 rounded-xl p-6 shadow-xl animate-fade-in">
        <form action="{{ route('game-accounts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
