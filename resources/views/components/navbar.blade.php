<nav x-data="{ open: false }" class="bg-gray-800 shadow-md sticky top-0 z-50 border-b border-gray-700"> <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      <div class="flex items-center">
        <a href="/" class="text-white text-xl font-bold">
          <img src="/images/ps=logo.png" alt="Logo Nexakun" class="h-16 w-auto">
        </a>
      ...
      <div class="hidden md:flex items-center space-x-2">
          <a href="#" class="text-white bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded-md text-sm font-medium">Login</a>
          <a href="#" class="text-white bg-green-500 hover:bg-green-600 px-3 py-2 rounded-md text-sm font-medium">Register</a>
      </div>
  ...
  <div x-show="open" class="md:hidden bg-gray-800" id="mobile-menu"> <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
    ...
    <div class="pt-4 pb-3 border-t border-gray-700">
        <div class="flex items-center px-5 mb-2"> <a href="#" class="w-full text-center text-white bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded-md text-sm font-medium">Login</a>
        </div>
        <div class="flex items-center px-5">
             <a href="#" class="w-full text-center text-white bg-green-500 hover:bg-green-600 px-3 py-2 rounded-md text-sm font-medium">Register</a>
        </div>
    </div>
  </div>
</nav>